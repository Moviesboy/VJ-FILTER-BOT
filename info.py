...
API_ID = int(environ.get('API_ID', '29751643'))
API_HASH = environ.get('API_HASH', '55cb9063091c217ef80e4d1d70f37c2a')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002168570294'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1481801633').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002175615780').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mrnobodytg026:NhSdSNIOtFtZDkBU@cluster0.nxq4i.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+p6JkdW23hShmMGJl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+wlniKTzhK95kZGFl')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/+p6JkdW23hShmMGJ1') # Support Chat Link Without https:// or @
